            ...
            if (option === "create_call") {
                ...
                try {
                    response = await sourcebin.create({
                        ...
                        description: `Copyright © Leinad Store`,
                        files: [
                            {
                                content: output,
                                language: 'text',
            ...
            if (option === "notify_user") {
                ...
                await interaction.update({
                    embeds: [
                        new Discord.EmbedBuilder()
                            .setColor(config.embeds_color.embed_invisible)
                            .setDescription(`<a:loading:1057823863909658767> | Apagando ticket em 5 segundos...`)
                    ],
                    components: [],
                    ephemeral: true
                })
                ...
                for (let i = 4; i >= 1; i--) {
                    ...
                    interaction.editReply({
                        embeds: [
                            new Discord.EmbedBuilder()
                                .setColor(config.embeds_color.embed_invisible)
                                .setDescription(`<a:loading:1057823863909658767> | Apagando ticket em ${i} segundos...`)
                        ],
                        components: [],
                        ephemeral: true
                    });
